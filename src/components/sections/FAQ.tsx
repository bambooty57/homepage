...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: '파워튜닝이 농기계에 안전한가요?',
      answer: '네, 안전합니다. TracForce(트랙포스)의 파워튜닝은 제조사가 설정한 안전 한계 내에서 이루어지며, 수년간의 연구와 테스트를 통해 검증된 방식을 사용합니다. 또한 모든 파워튜닝에는 품질 보증이 제공됩니다.'
    },
    {
      question: '어떤 농기계에 파워튜닝이 가능한가요?',
      answer: '대부분의 현대식 디젤 엔진을 탑재한 농기계(트랙터, 콤바인 등)에 파워튜닝이 가능합니다. 구체적인 모델 적용 가능 여부는 상담을 통해 확인해 드립니다.'
    },
    {
    ...
    {
      question: '파워튜닝 작업은 얼마나 걸리나요?',
      answer: '일반적으로 2-3시간 정도 소요됩니다. 작업 전 진단과 파워튜닝 후 테스트 시간을 포함한 시간입니다.'
    },
    {
      question: '파워튜닝 후 사후 관리는 어떻게 되나요?',
      answer: '파워튜닝 후 30일간 무상 점검 및 미세 조정을 제공합니다.'
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <p className="text-gray-600 text-center mb-12">
        TracForce(트랙포스) 파워튜닝 서비스에 대해 자주 묻는 질문들을 모았습니다.
      </p>
